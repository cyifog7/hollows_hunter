...
public:
    ...
    void toString(std::wstringstream &stream, const pesieve::t_results_filter rfilter) const;

protected:
    size_t reportsToString(std::wstringstream &stream, const pesieve::t_results_filter rfilter) const;

    size_t toJSON(std::wstringstream &stream, const t_hh_params &params) const;
    size_t reportsToJSON(std::wstringstream &stream, size_t level, const t_hh_params &params) const;
    ...
    std::map<DWORD, vt::VTResult> pidToVT;
